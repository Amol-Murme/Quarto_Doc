...
format:
  html:
    output-file: "output/html/ABC Bank Ltd.html"
  docx:
    output-file: "output/docx/ABC Bank Ltd.docx"  
...
Methodology Overview Table:
 ...
 ![Model Development Pipeline](../input/images.jpeg)
...
### Important Features
  ...
  ![Partial Dependance Graph](../input/pdg.png)

### Model Performance
  Following are the model performance statistics on validation and OOS test dataset:
  **Validation dataset**

  ![Model Performance on Validation dataset](../input/roc.png)

  **Test dataset**

  ![Model Performance on Test dataset](../input/roc.png)

### Model Stability
  Following are model stability statistics:
  **Train vs. Validation dataset**
  ![Model Stability (Val vs. Train dataset)](../input/roc.png)

  **Validation vs. Test dataset**
  ![Model Stability (Val vs. Test dataset)](../input/roc.png)
